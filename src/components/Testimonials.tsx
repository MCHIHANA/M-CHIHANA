...
const testimonials = [
  ...
  },
  {
    ...
    image: 'ER',
    content: 'A true professional who understands both the technical and business aspects. Our website performance improved dramatically after the optimization work.',
    rating: 5,
  },
];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all"
              >
